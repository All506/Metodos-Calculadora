...
function mm1inf(event) {

    event.preventDefault()

    var lambda = parseFloat(document.getElementById("lambdaField").value);
    var miu = parseFloat(document.getElementById("miuField").value);
    var N = parseFloat(document.getElementById("NField").value);

    if (document.getElementById("lambdaField").value.length == 0 || document.getElementById("miuField").value.length == 0 || document.getElementById("NField").value.length == 0) {
        alert("Hay espacios vacios. Rellene todos antes de continuar..");
    } else {
